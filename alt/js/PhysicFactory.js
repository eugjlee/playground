...
var physicWorld;
function getProxyMesh( object, geometryType ) {
...
PhysicFactory.prototype.addFloor = function( width, height ) {
...
PhysicFactory.prototype.mesh2ammo = function( mesh, mass ) {
	...
	*/
	...
	if ( type === "BoxGeometry" || type === "BufferGeometry" ) {
