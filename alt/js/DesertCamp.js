...
DesertCamp.prototype.update = function( dt ) {

	this.crashSmoke.tick( dt );

};

DesertCamp.prototype.dispose = function() {
...
DesertCamp.prototype.init = function() {
...
DesertCamp.prototype._getSkyBox = function() {
...
DesertCamp.prototype._getFloor = function( width, height ) {
...
DesertCamp.prototype.preload = function( manager ) {
